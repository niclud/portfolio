...
<div class="relative w-screen h-screen">
	<div class="absolute w-full h-full">
		<img src="images/digitization.jpg" alt="ninary image" class="w-full h-full object-cover" />
...
<div class="w-screen h-screen flex flex-col sm:flex sm:flex-row" id="acercademi">
	<div class="sm:w-1/2 p-16 grid place-content-center">
		<img
	...
	<div class="sm:w-1/2 grid items-center p-16 text-white place-content-center gap-5">
		<div>
			<h2 class="text-lg font-bold">Nicolás Ludueña</h2>
